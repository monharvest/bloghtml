...
const categoryNames: Record<string, string> = {
  ...
  'advent': "Advent",
  'ukhal-ba-amilal': "Үхэл ба амилал",
  'munkh-ugiin-oilgolt': "Мөнх үгийн ойлголт",
  'tamiin-tukhai': "Тамын тухай",
  
  // Legacy support
  'gospel': "Сайн мэдээ",
  'death and resurrection': "Үхэл ба амилал",
  'parables': "Сургаалт зүйрлэлүүд",
  'about eon': "Мөнх үгийн ойлголт",
  'about hell': "Тамын тухай",
  // Additional mappings
  'death-and-resurrection': "Үхэл ба амилал",
  'good-news': "Сайн мэдээ",
  'about-eon': "Мөнх үгийн ойлголт",
  'about-hell': "Тамын тухай",
}
...
const categoryDescriptions: Record<string, string> = {
  ...
  'ukhal-ba-amiral': "Үхэл ба амилалын тухай нийтлэлүүд",
  'munkh-uunii-oilgolt': "Мөнх үгийн ойлголт",
  'tamyn-tukhai': "Тамын тухай нийтлэлүүд",
  ...
  'health': "Үхэл ба амилалын тухай нийтлэлүүд",
  'education': "Сургаалт болон зүйрлэлүүд",
  'games': "Мөнх үгийн ойлголт",
  'youth': "Тамын тухай нийтлэлүүд",
  // Additional mappings
  'death-and-resurrection': "Үхэл ба амилалын тухай нийтлэлүүд",
  'good-news': "Есүсийн хайр ба нигүүлслийн тухай өгүүлэх андраар сургаалт зүйрлэлийн түүн уттаг тайлбарлав.",
  'parables': "Сургаалт болон зүйрлэлүүд",
  'about-eon': "Мөнх үгийн ойлголт",
  'about-hell': "Тамын тухай нийтлэлүүд",
}
